<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Layout/SiteWeb.Master" CodeBehind="Cobranza.aspx.vb" Inherits="sycsa.Web.Cobranza" %>
                  ...
                  "htmlContent" : "true",
                    ...
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th class="col-auto text-center" data-sortable="true" data-field="fecha_alta" data-sorter="dateSort">Fecha Alta</th>
                            <th class="col-auto text-center" data-sortable="true" data-field="fecha_real" data-sorter="dateSort">Fecha Real</th>
                            <th class="col-auto text-center" data-field="total">Total Aplicado</th>
                        ...
                        <asp:ListView ID="ListProducts" runat="server" ConvertEmptyStringToNull="true"
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td data-title="fecha_alta" class="text-center">
                                        <%# Format(Eval("FECHA_ALTA"), "dd/MM/yyyy")%>
                                    </td>
                                    <td data-title="fecha_real" class="text-center">
                                        <%# Format(IIf(IsDBNull(Eval("FECHA_REAL")), Eval("FECHA_ALTA"), Eval("FECHA_real")), "dd/MM/yyyy")%>
                                    </td>
                                    <td data-title="total" class="text-right font-weight-bold">
                                        <%# Format("{0:C}", Eval("TOTAL_APLICADO"))%>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <asp:LinkButton runat="server" ID="Imprimir" CommandName="Imprimir"
                                            CommandArgument='<%# Eval("Clave") & ";" & Eval("Tipo_Doc")%>' Style="font-size: 12px;">
                                            <label id="Label1" runat="server" class="fa fa-file-pdf-o" style="font-size: 14px; color: red; cursor: pointer;"> Descargar</label>
                                        </asp:LinkButton>
                                    </td>
                                    <td data-title="XML" class="text-center">
                                        ...
                                        <asp:LinkButton runat="server" ID="ImprimirXML" CommandName="ImprimirXML"
                                            ...
                                            <label id="Label2" runat="server" class="fa fa-file-excel-o" style="font-size: 14px; color: green; cursor: pointer;"> Descargar</label>
                                        </asp:LinkButton>
