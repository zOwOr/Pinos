    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="category-results">
                ...
                <asp:DropDownList ID="ResultPage" runat="server" AppendDataBoundItems="true" CssClass="chosen-select" AutoPostBack="True" Height="25px" Width="72px">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="pagination">
                <div class="page-button" style="font-size: small">

                    <asp:DataPager ID="dataPagerNumeric" PagedControlID="ListProducts"
                        runat="server" PageSize="5">
                        <Fields>
                            <asp:NextPreviousPagerField FirstPageText="Primera Pagina     " LastPageText="Última   Pagina   " NextPageText="Siguiente         " PreviousPageText="Anterior       " ShowFirstPageButton="True" ShowLastPageButton="True" />
        ...
        <div id="no-more-tables">
            <table class="col-md-12 table-bordered table-striped table-condensed cf">
                <thead class="cf">
                    <tr>
                        <th>Codigo</th>
                        <th style="width: 109px">Producto</th>
                        ...
                        <ItemTemplate>
                            ...
                            <tr>
                                ...
                                <td data-title="Precio" class="numeric">
                                    <span class="price"><%#  FormatCurrency(Eval("UnitPrice"))%>  </span>
                                </td>
