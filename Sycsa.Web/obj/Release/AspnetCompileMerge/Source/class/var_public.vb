...
#Region "Variables para titulos y etiquetas de la master"
    ...
    Public _Layout_img1_titulo As String = "Cleveland"
    Public _Layout_img1_descripcion As String = "La linea mas completa en herramientas de corte."
    Public _Layout_img2_titulo As String = "CDN"
    Public _Layout_img2_descripcion As String = "Conductores Electricos."
    Public _Layout_img3_titulo As String = "Coflex"
    Public _Layout_img3_descripcion As String = "Lo mejor en plomeria."
