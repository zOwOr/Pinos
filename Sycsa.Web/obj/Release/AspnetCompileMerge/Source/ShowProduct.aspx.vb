        ...
        Try
            ...
            If datos.Rows.Count > 0 Then
                ...
                For Each irow As DataRow In datos.Rows
                    ...
                    _ElementHtml = _ElementHtml & "<li>" & _
                                    " <a class=""fancybox"" rel=""product-images"" href=""" & irow("ProductImagen") & """></a> " & _
                                    " <img src=""" & irow("ProductImagen") & """ data-large=""" & irow("ProductImagen") & """ alt="""" /> " & _
                                    "</li>"
            ...
            For Each irow As DataRow In datosRelated.Rows
                ...
                _ElementHtml = _ElementHtml & "<div>" & _
                                         "<div class=""product"">" & _
                                        "	<div class=""product-image"">" & _
                                        "		<img src=""" & IIf(IsDBNull(irow("ProductImagen")) = False, irow("ProductImagen"), "/imagen/no_image.gif") & """ width=""65%"" alt=""" & irow("ProductName") & """>" & _
                                        "	</div>" & _
                                         " " & _
                                        "	<div class=""product-info"">" & _
                                        "		<h5><a href=""ShowProduct.aspx?pk=" & irow("ProductID") & """>" & irow("ProductName") & "</a></h5>" & _
                                        "		<span class=""price"">" & IIf(irow("hiddenPrice") = 1, "", FormatCurrency(irow("UnitPrice"), 2)) & "</span>" & _
                                        "		<div class=""rating readonly-rating"" data-score=""4""></div>" & _
                                        "	</div>" & _
                                        " " & _
                                        "	<div class=""product-actions"">" & _
                                        " " & _
                                        "		<span class=""add-to-cart"" style=""width:12px !important;""   onclick=""return AddCart(' " & irow("ProductID") & " ');"" > " & _
                                        "			<span class=""action-wrapper""  >" & _
                                        "				<i class=""icons icon-basket-2"" ></i>   " & _ButtonCart & _
                                        "			</span>" & _
                                        "		</span>" & _
                                        " " & _
                                        "	</div>" & _
