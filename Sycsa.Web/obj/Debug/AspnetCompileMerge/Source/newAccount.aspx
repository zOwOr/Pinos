            ...
            <div class="page-content">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        <asp:TextBox ID="txtREmail" runat="server" data-require="true" required></asp:TextBox>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        <asp:TextBox ID="txtRPassword" runat="server" data-require="true" required></asp:TextBox>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        <asp:TextBox ID="txtName" runat="server" data-require="true" required></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        <asp:TextBox ID="txtPhone" runat="server" data-require="true" required></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4">
