        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="page-content contact-info">
                ...
                <div class="contact-form">
                    ...
                    <asp:TextBox ID="txtPass" runat="server" data-require="true" TextMode="Password" placeholder="Password" required></asp:TextBox>
                </div>

                <div class="contact-form">
                    <label>Repetir Contraseña</label>
                    <asp:TextBox ID="txtPassRepeat" runat="server" data-require="true" TextMode="Password" placeholder="Password" required></asp:TextBox>
                </div>
